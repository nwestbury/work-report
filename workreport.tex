...
\begin{enumerate}[label*={},leftmargin=*,labelsep=2ex,ref=\arabic*]
    ...
    \item Table 2 --- Integration Testing Pros and Cons \dotfill 7
...
\captionof{figure}{The cost of fixing a bug increases dramatically the later it is caught in development. [4]}
\end{center}
\par\noindent
